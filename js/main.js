...
function maybeCreateStream() {
	...
	remoteStream = fileVideo.captureStream();
}
...
async function call() {
	...
	console.log('Added remote stream to pc2');
...
function getRecordingStream (videoTrack, audioTrack, localAudio) {
...
const startVideoRecording = () => {
	...
	getRecordingStream(remoteVideoTrack, remoteAudioTrack, localAudioTrack).then(
		recordingStream => {
			videoRecorder = new VideoRecorder(recordingStream);
			setTimeout(() => {
